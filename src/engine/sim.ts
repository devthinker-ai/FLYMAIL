...
export class FlySim {
  ...
  setExternalInput(values: Float32Array) {
    ...
    // Cast: @webgpu/types BufferSource vs Float32Array<ArrayBufferLike>
    this.device.queue.writeBuffer(this.extBuf, 0, values as unknown as GPUAllowSharedBufferSource);
  }
